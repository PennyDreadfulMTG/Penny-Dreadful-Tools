...
echo "Looking at network"

if [ "$ft_network" == "1" ];
then
  say "${e}==>${x} Detecting git/mercurial file structure"
  echo "git_root $git_root"
  echo "git_ls_files_recurse_submodules_o $git_ls_files_recurse_submodules_o"
  ...
  echo "Looking at network funky stuff"
...
echo "Presumably we do not get this far"
