...
class Rotation(View):
    def __init__(self, in_rotation: bool, runs: int, num_cards: int, in_this_check: int = 0, eliminated_this_check: int = 0) -> None:
        super().__init__()
        self.runs = runs
        self.runs_percent = rotation.runs_percentage(runs)
        self.total_runs = rotation.TOTAL_RUNS
        self.num_cards = num_cards
        self.in_this_check = in_this_check
        self.eliminated_this_check = eliminated_this_check
