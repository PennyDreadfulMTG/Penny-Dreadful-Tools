...
class Tournaments(View):
    def __init__(self):
        ...
        if pdm_time < pdt_time and pdm_time < pds_time:
            ...
            next_time = pds_time
        self.next_tournament_time_precise = dtutil.dt2ts(next_time) - now_ts
        self.next_tournament_time = dtutil.display_time(self.next_tournament_time_precise, granularity=1)
        self.tournaments = [
            {
