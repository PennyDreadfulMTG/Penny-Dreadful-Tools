...
class Odds(Extension):
    ...
    @slash_command('odds')
    @slash_option(name='copies', description='How many copies are you running? (Default 4)', opt_type=OptionType.INTEGER, required=False)
    @slash_option(name='drawn', description='How many cards have you drawn? (Default 7)', opt_type=OptionType.INTEGER, required=False)
    @slash_option(name='needed', description='How many do you need to draw? (Default 1)', opt_type=OptionType.INTEGER, required=False)
    @slash_option(name='deck_size', description='How big is your deck? (Default 60)', opt_type=OptionType.INTEGER, required=False)
