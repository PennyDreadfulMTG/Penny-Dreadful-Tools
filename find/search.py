...
def is_subquery(subquery_name: str) -> str:
    ...
    subqueries = {
        ...
        'bounceland': 't:land (o:"When ~ enters, return a land you control to its owner\'s hand" OR o:/When ~ enters, sacrifice it unless you return an untapped .* you control to its owner\'s hand/)',
        ...
        'gainland': 't:land o:"When ~ enters, you gain 1 life."',
        'historic': 't:artifact OR t:legendary OR t:saga',
        'outlaw': 't:Assassin OR t:Mercenary OR t:Pirate OR t:Rogue OR t:Warlock',
        'painland': r't:land o:/Add \{.\} or \{.\}. ~ deals 1 damage to you./ -o:"~ enters tapped"',
        'permanent': 't:artifact OR t:creature OR t:enchantment OR t:land OR t:planeswalker',
        'scryland': 't:land "Temple of" o:"When ~ enters, scry 1"',
        'shadowland': "t:land o:/As ~ enters, you may reveal an? [a-z]+ or [a-z]+ card from your hand. If you don't, ~ enters tapped./",
        'shockland': 't:land o:"As ~ enters, you may pay 2 life. If you don\'t, it enters tapped."',
        'slowland': 't:land o:"~ enters tapped unless you control two or more other lands."',
        ...
        'tangoland': 't:land o:"~ enters tapped unless you control two or more basic lands."',
