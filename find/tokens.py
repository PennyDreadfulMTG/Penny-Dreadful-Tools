...
class Key(Token):
    # Strict substrings of other operators must appear later in the list.
    values = ['coloridentity', 'fulloracle', 'commander', 'supertype', 'toughness', 'identity', 'playable', 'edition', 'subtype', 'loyalty', 'format', 'oracle', 'rarity', 'color', 'power', 'super', 'mana', 'text', 'type', 'cmc', 'pow', 'set', 'sub', 'tou', 'cid', 'ci', 'fo', 'id', 'mv', 'c', 'e', 'f', 'm', 'r', 's', 'o', 't', 'is', 'p']
