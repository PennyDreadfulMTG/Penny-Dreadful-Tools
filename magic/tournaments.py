...
def upcoming_tournament_info() -> list[dict[str, Any]]:
    tournaments = []
    for tournament in get_all_next_tournament_dates(dtutil.now(dtutil.GATHERLING_TZ)):
        tournaments.append(get_tournament_details(tournament))
    return tournaments


def tournament_info(time_direction: TimeDirection, units: int = 2) -> dict[str, Any]:
    info = get_nearest_tournament(time_direction)
    return get_tournament_details(info, units)


def get_tournament_details(date: TournamentDateType, units: int = 2) -> dict[str, Any]:
    tournament_id, name, time = date
...
def all_series_info() -> list[Container]:
    ...
    return [
        Container(
            {
                ...
                'time': info[FNM][2],
                'series_name': 'Penny Dreadful FNM',
        ...
        Container(
            {
                ...
                'time': info[SAT][2],
                'series_name': 'Penny Dreadful Saturdays',
                'sponsor_name': 'Cardhoarder',
            }
        ),
        Container(
            {
                ...
                'time': info[APAC][2],
                'series_name': 'APAC Penny Dreadful Sundays',
                'sponsor_name': 'Cardhoarder',
            }
        ),
        Container(
            {
                ...
                'display_time': '1:30pm Eastern',
                'time': info[SUN][2],
                'series_name': 'Penny Dreadful Sundays',
                'sponsor_name': 'Cardhoarder',
            }
        ),
        Container(
            {
                ...
                'display_time': '7pm Eastern',
                'time': info[MON][2],
                'series_name': 'Penny Dreadful Mondays',
                'sponsor_name': 'Cardhoarder',
            }
        ),
        # Container({
        ...
        #     'display_time': '7pm Eastern',
        #     'time': info[TUE][2],
        #     'series_name': 'Penny Dreadful Tuesdays',
        #     'sponsor_name': None,
        # }),
        Container(
            {
                ...
                'display_time': '7pm Eastern',
                'time': info[THU][2],
                'series_name': 'Penny Dreadful Thursdays',
                'sponsor_name': 'Cardhoarder',
            }
        ),
    ]
