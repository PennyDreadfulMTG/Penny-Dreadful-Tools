...
from flask import (Flask, Request, Response, redirect, request, send_from_directory,
                   session, url_for)
...
def log_exception(request: Request, e: Exception) -> None:
    logger.error(f'At request path: {request.path}', repo.format_exception(e))
