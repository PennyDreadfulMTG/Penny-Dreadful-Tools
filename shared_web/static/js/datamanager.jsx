...
export class DataManager extends React.Component {
    ...
    load() {
        ...
        const params = {
            ...
            deckType,
            "enemyArchetypeId": this.props.enemyArchetypeId,
            "enemyCard": this.props.enemyCard,
            "enemyPersonId": this.props.enemyPersonId,
            "heroArchetypeId": this.props.heroArchetypeId,
            "heroCard": this.props.heroCard,
            "heroPersonId": this.props.heroPersonId,
            page,
            pageSize,
...
DataManager.propTypes = {
    ...
    "enemyArchetypeId": PropTypes.string,
    "enemyCard": PropTypes.string,
    "enemyPersonId": PropTypes.string,
    ...
    "heroArchetypeId": PropTypes.string,
    "heroCard": PropTypes.string,
    "heroPersonId": PropTypes.string,
